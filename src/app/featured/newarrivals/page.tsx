...
import NewArrivalsPageContent from "@/components/featured-page-content/newarrivals"

export default function NewArrivalsPage() {
  return (
    <Suspense fallback={<NewArrivalsPageSkeleton />}>
      <NewArrivalsPageContent />
    </Suspense>
  )
}

function NewArrivalsPageSkeleton() {
  return (
