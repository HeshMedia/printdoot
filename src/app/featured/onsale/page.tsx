...
import { Zap, Tag, Loader2 } from "lucide-react"
      ...
      <div className="flex flex-col md:flex-row gap-8">
                      ...
                      <div key={rating} className="flex items-center gap-2">
                        ...
                        <Label htmlFor={`rating-${rating}`} className="flex items-center">
                          {Array.from({ length: rating }).map((_, i) => (
                            <Tag key={i} className="h-4 w-4 fill-red-500 text-red-500" />
                          ))}
                          {Array.from({ length: 5 - rating }).map((_, i) => (
                            <Tag key={i} className="h-4 w-4 text-gray-200" />
                          ))}
        ...
        <div className="w-full md:w-3/4">
          ...
          <div className="mb-6">
            ...
            <p className="text-muted-foreground">Incredible deals and discounts on high-quality items</p>
          </div>
                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center">
                          <Tag className="h-4 w-4 fill-red-500 stroke-red-500 mr-1" />
